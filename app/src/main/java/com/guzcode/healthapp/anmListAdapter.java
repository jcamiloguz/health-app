...
class anmListAdapter extends BaseAdapter {

    Context context;
    ArrayList<anmPatient> patientsData;
    private static LayoutInflater inflater = null;

    public anmListAdapter(Context context, ArrayList<anmPatient> patientsData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listInfo.setText("cc: " + patientsData.get(position).cc +" - "+ patientsData.get(position).BornDate +" - "+patientsData.get(position).email);
